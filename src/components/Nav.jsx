...
import { LayoutDashboard, Users, LogIn, Stethoscope, AlertTriangle, LogOut, Menu, X, CalendarDays, UserCog, UserCheck, Shirt, FileText } from 'lucide-react'
...
export default function Nav({ page, onNavigate, onLogout }) {
