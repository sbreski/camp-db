...
export default function ImportParticipants({ onImport, onClose, existingParticipants = [] }) {
  ...
  function downloadTemplate() {
    const headers = [
      'Full Name',
      'Pronouns',
      'If you selected "Prefer to self-describe", please tell us your child\'s pronouns',
      'Age',
      'Date of Birth',
      'Address',
      'Postcode',
      ...
      'Parent Phone',
      'Parent Email',
      'Permission to Leave Unaccompanied (wording for answer is: "I give my child permission to travel home by themselves (only relevant to pupil\'s 11+)" or "Myself or an authorised adult (named below) will collect my child after each session")',
      'Please provide names of adults permitted to pick up my child from camp (this will be separated by commas)',
      'Does your child have any medical conditions we should be aware of?',
      'Medical Info',
      'Does your child need to take medication during the camp day?',
      'Medication Details',
      'Please tell us about any allergies, intolerances, or dietary requirements your child has.',
      'Does your child have any additional needs or require adjustments to take part fully in the camp?',
      'Is there anything else you’d like us to know to help your child have a positive experience at camp?',
      'Does your child have an EHCP or receive additional support in school (for example, learning support or regular adult support)?',
      'If yes or not sure, please tell us more',
      'Declaration of additional needs (I confirm that I have shared full details of my child’s needs, including any EHCP, 1:1 support in school, or other significant support requirements, so that artsdepot and Impact Theatre Company can plan appropriate support for the camp.)',
      'Siblings?',
      'Siblings Name',
      'Photo Consent',
    ].join(',')
    ...
    const example = [
      ...
      '07700000000',
      'sarah@email.com',
      'Myself or an authorised adult (named below) will collect my child after each session',
      'Sarah Smith (Parent), Grandma Smith (Grandmother)',
      'Yes',
      'Carries inhaler',
      'No',
      '',
      'Peanut allergy; Vegetarian',
      'Needs visual timetable and movement breaks',
      'Prefers quiet check-in',
      'yes',
      'Autism spectrum condition',
      'Declaration completed by parent/guardian',
      'yes',
      'Tom Smith',
      'yes',
