...
const FIELD_MAP = {
  ...
  parentRelationship: ['parent relationship', 'guardian relationship', 'relationship to child', 'primary adult relationship'],
  ...
  parent2Name: ['parent 2 name', 'second parent name', 'additional adult name', 'secondary guardian name'],
  parent2Relationship: ['parent 2 relationship', 'second parent relationship', 'additional adult relationship', 'secondary guardian relationship'],
  parent2Email: ['parent 2 email', 'second parent email', 'additional adult email', 'secondary guardian email'],
