...
function toSnake(obj) {
  const map = {
    ...
    approvedAdults: 'approved_adults', medicalType: 'medical_type', medicalCondition: 'medical_condition', medicalDetails: 'medical_details',
    ...
    pickupCodeOverrides: 'pickup_code_overrides',
    pickupCodeVerifications: 'pickup_code_verifications',
    otcAllowedItems: 'otc_allowed_items', otcNotes: 'otc_notes',
    dietaryType: 'dietary_type', allergyDetails: 'allergy_details', hasEpiPen: 'has_epipen', mealAdjustments: 'meal_adjustments',
...
function toCamel(obj) {
  const map = {
    ...
    approved_adults: 'approvedAdults', medical_type: 'medicalType', medical_condition: 'medicalCondition', medical_details: 'medicalDetails',
    ...
    pickup_code_overrides: 'pickupCodeOverrides',
    pickup_code_verifications: 'pickupCodeVerifications',
    otc_allowed_items: 'otcAllowedItems', otc_notes: 'otcNotes',
    dietary_type: 'dietaryType', allergy_details: 'allergyDetails', has_epipen: 'hasEpiPen', meal_adjustments: 'mealAdjustments',
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f3ef]">
      ...
      <main className={`pt-14 ${page === 'dashboard' ? 'md:pt-0' : 'md:pt-14'} md:ml-56`}>
